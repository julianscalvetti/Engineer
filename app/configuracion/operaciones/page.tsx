import { OperationConfig } from "@/components/configuration/operation-config";
import { createClient } from "@/lib/supabase/server";

export const dynamic = "force-dynamic";

export default async function OperacionesConfiguracionPage() {
  const initialData = await getInitialData();

  return <OperationConfig {...initialData} />;
}
